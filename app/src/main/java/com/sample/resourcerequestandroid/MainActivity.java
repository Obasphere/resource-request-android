...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //This code is to create the content layout
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    // This code is to create the Path Parameters (First Name, Middle Name and Last Name)
                    ...
                    //This code is to create a resource request
                    ...
                    // The following code is to send the request, and handle success and failure responses
